...
{
    /** @return array{experiences: list<array<string, mixed>>, education: list<array<string, mixed>>, languages: list<array<string, mixed>>, language_note: string|null, source: string, updated_at: CarbonImmutable|null} */
    public function publicData(): array
    {
        return [
            ...
            'language_note' => config('portfolio.language_note'),
