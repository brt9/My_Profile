...
final class CalendarEventManager
{
    ...
    public function create(User $user, array $data): CalendarEvent
    {
        ...
        return $this->syncToGoogle($event, (bool) ($data['sync_google'] ?? false));
    }
    ...
    public function update(CalendarEvent $event, array $data): CalendarEvent
    {
        ...
        return $this->syncToGoogle($event->fresh(), (bool) ($data['sync_google'] ?? false));
    }
    ...
    private function syncToGoogle(CalendarEvent $event, bool $requested): CalendarEvent
    {
        if (! $requested || ! config('services.google_calendar.write_enabled')) {
            return $event;
        }
