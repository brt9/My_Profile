...
- Google Calendar solicita somente o escopo configurado, conecta automaticamente após o login administrativo, criptografa o refresh token e nunca persiste descrições, participantes ou links;
