            ...
            <div className="dashboard-shell">
                <section className="dashboard-welcome">
                    <div>
                        ...
                        <p>O banco local é a fonte principal. O Google é conectado no login e sincronizado automaticamente.</p>
                    </div>
                    <a className="dashboard-primary-link" href="/#agenda">
                        {canManageCalendar ? 'Gerenciar agenda →' : 'Abrir agenda pública →'}
                    </a>
                </section>
                ...
                <div className="dashboard-status-grid">
                    ...
                    <article className="dashboard-card">
                        ...
                        <strong>{googleCalendarConnected ? 'Conectado automaticamente' : googleCalendarConfigured ? 'Conecta no próximo login' : 'Não configurado'}</strong>
                        <p>{googleCalendarWriteEnabled ? 'Novos compromissos são enviados automaticamente.' : 'Permissão somente de leitura.'}</p>
                    </article>
                </div>
